# study
--Обновление на 24.02.19--
1. Добавлены donate: paypal и yandex
2. Немного подправлена верстка
3. Отображения в 2 колонки загруженных картинов на странице rating
